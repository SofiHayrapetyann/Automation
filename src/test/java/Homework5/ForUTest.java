...
public class ForUTest {
    ...
    public void testAddToBasket() throws InterruptedException {
        ...
        WebElement realName = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//p//a[@href=\"/hy/product/zartucic-kupong\"]")));
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@id='offer1']//div[@class='swiper-slide'][1]//div[@class='item_basket']")));
        basketElement.click();
        WebElement toBasketElm = driver.findElement(By.xpath("//div[@id='basketIcon']"));
        toBasketElm.click();
        WebElement expectedTitle = driver.findElement(By.xpath("//div[@class='spinner_flex']//a//h4"));
